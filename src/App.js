...
function App() {
// user information set function call
...
// name onBlur function call

 const handleNameChange = e =>{
   setName(e.target.value);
 }

// email onchange function call
const handleEmailChange = e =>{
  setEmail(e.target.value);
  console.log(email,password)
}
// password onChange function call
const handlePasswordChange = e=>{
  setPassword(e.target.value);
}

// Register Button function call
...
const registerNewUser = (email,password) => {
  ...
  return (
    ...
    <div className="col-sm-10">
      <input onBlur={handleNameChange} type="email" className="form-control" id="inputName" placeholder='Enter Your Name' required/>
    </div>
  </div>}   
